...
Dla alfabetu składającego się z $4$ symboli, algorytmy również nie są w~stanie rozegrać zbyt długiej partii. Przy rozgrywce, w~której udział bierze zachłanny algorytm pełniący rolę \emph{budowniczego}, niezależnie od taktyki wybranej przez algorytm \emph{malarza}, rozgrywka zakończy się maksymalnie po $10$ ruchu.
