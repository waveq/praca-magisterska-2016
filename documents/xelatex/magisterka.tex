...
Ciężko jest dopatrzyć się podobnej cykliczności w algorytmie z zagnieżdżeniami, nawet pierwszego poziomu. Algorytm ten skupia się raczej na grupie indeksów będących obok siebie. Wykres \ref{fig:buildersPickedIndexes} przedstawia rozkład wybieranych indeksów przez oba algorytmy. Rozgrywki nie trwały więcej niż 115 ruchów, na rysunku można zaobserwować, że najczęściej wybierane indeksy przez algorytm z zagnieżdżeniami należały do zbioru $\leq 27$. Natomiast indeksy wybierane przez algorytm zachłanny, są w miarę równomiernie rozłożone przez wszystkie indeksy. Ponadto, mimo wyłamania się z wcześniej wspomnianej \textit{taktyki iteracyjnej}, algorytm zachłanny w dalszym ciągu działa cyklicznie, wybierając indeksy po zero, jeden lub pięć razy.

\begin{figure}[h]
    \centering
    \includegraphics[scale = 0.7]{images/buildersPickedIndexes}
...
\bibitem{repetition} Axel Thue's work on repetitions in words
\bibitem{narad} N. Rampersad Overlap-Free Words and Generalizations (2007)
\bibitem{prouhet} M. E. Prouhet. M ́emoire sur quelques relations entre les puissances des nom- bres. \textit{C. R. Acad. Sci. Paris} \textbf{33} (1851), 225.
\bibitem{carpi} A. Carpi, On the size of a squarefree morphism on a three letter alphabet, \textit{Inform. Proc. Letters} \textbf{16} (1983), 231-235.
\bibitem{first} A. Ku ̈ndgen and M. J. Pelsmajer, Nonrepetitive colorings of graphs of bounded treewidth, \textit{Discrete Math} \textbf{308} (2008), 4473–4478
\bibitem{thueonline2} J. Grytczuk, J. Kozik, P. Micek, New approach to nonrepetitive sequences. \textit{Random Structures Algorithms}, DOI 10.1002/rsa.20411.

\bibitem{second} J. Bara ́t, P. P. Varju ́. On square-free vertex colorings of graphs. \textit{Studia Sci. Math. Hungar} \textbf{44} (2007) 411–422
\bibitem{thueonline} J. Grytczuk, P. Szafruga, M. Zmarz, Online version of the theorem of Thue (2012)
